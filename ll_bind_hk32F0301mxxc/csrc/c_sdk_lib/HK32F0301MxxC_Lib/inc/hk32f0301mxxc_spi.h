/********************************************************************************
  ...
  * @Filename£ºhk32f0301mxxc_spi.h 
  * @Brief£ºHow to config MCU and periph clock
  * @Author£ºAE TEAM
  *******************************************************************************/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __HK32F0301MXXC_SPI_H
#define __HK32F0301MXXC_SPI_H
...
#define IS_SPI_1_PERIPH(PERIPH) (((PERIPH) == SPI))
...
/** @defgroup SPI_CRC_length SPI_CRC_length
  * @{
  */
...
/** @defgroup SPI_FIFO_reception_threshold SPI_FIFO_reception_threshold
  * @{
  */
...
/** @defgroup SPI_DMA_transfer_requests SPI_DMA_transfer_requests
  * @{
  */
...
/** @defgroup SPI_last_DMA_transfers SPI_last_DMA_transfers
  * @{
  */
...
/** @defgroup SPI_interrupts_definition SPI_interrupts_definition
  * @{
  */
...
/** @defgroup SPI_transmission_fifo_status_level SPI_transmission_fifo_status_level
  * @{
  */ 
...
/** @defgroup SPI_reception_fifo_status_level SPI_reception_fifo_status_level
  * @{
  */ 
...
/** @defgroup SPI_flags_definition SPI_flags_definition
  * @{
  */
