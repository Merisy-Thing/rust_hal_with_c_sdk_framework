...
#ifndef __HK32F0301MXXC_GPIO_H
#define __HK32F0301MXXC_GPIO_H
...
/** @defgroup GPIOMode_TypeDef GPIOMode_TypeDef
  * @{
  */
typedef enum
{
...
/** @defgroup Output_type_enumeration Output_type_enumeration
  * @{
  */
typedef enum
{
...
/** @defgroup Output_Maximum_frequency_enumeration Output_Maximum_frequency_enumeration
  * @{
  */
typedef enum
{
  GPIO_Speed_Level_1  = 0x00, /*!< I/O output speed: Level_1 */
  GPIO_Speed_Level_2  = 0x01, /*!< I/O output speed: Level_2 */
  GPIO_Speed_Level_3  = 0x03, /*!< I/O output speed: Level_3 */
}GPIOSpeed_TypeDef;
...
/** @defgroup Configuration_PullUp_PullDown_enumeration Configuration_PullUp_PullDown_enumeration
  * @{
  */
typedef enum
{
...
/** @defgroup Bit_SET_and_Bit_RESET_enumeration Bit_SET_and_Bit_RESET_enumeration
  * @{
  */
typedef enum
{ 
...
/** 
  ...
  */
#define GPIO_AF_6            ((uint8_t)0x06) /*(MIPI)BEEP */
/** 
...
/** @defgroup  IOMUX_PIN_selection   IOMUX_PIN_selection  
  * @{
  */ 
#define GPIOMUX_AF3_TIM1CH3       ((uint8_t)0x01) /* PC3/PD7_AF3_TIM1CH3  */   //  PC3/PD7 AS AF3
#define GPIOMUX_AF3_TIM1CH1N      ((uint8_t)0x02) /* PC3_AF3_TIM1CH1N  */  //  PC3 AS AF3
#define GPIOMUX_AF3_TIM1CH4       ((uint8_t)0x03) /* PC4_AF3_TIM1CH4  */   //  PC4 AS AF3
#define GPIOMUX_AF3_TIM1CH2N      ((uint8_t)0x04) /* PC4_AF3_TIM1CH2N  */  //  PC4 AS AF3
#define GPIOMUX_AF0_SWCLK         ((uint8_t)0x05) /* PB5_AF0_SWCLK    */   //  PB5 AS AF0
#define GPIOMUX_AF0_I2C_SDA       ((uint8_t)0x06) /* PB5_AF0_I2C_SDA   */  //  PB5 AS AF0 
#define GPIOMUX_AF3_TIM1BKIN      ((uint8_t)0x07) /* PD7_AF3_I2C_SDA   */  //  PD7 AS AF3
...
/** @defgroup GPIO_IOMUX GPIO_IOMUX
  * @{
  */
...
#define IOMUX_PD7_TIM1_CH3          0xFFFFFFF7 
#define IOMUX_PD7_TIM1_BKIN         0x00000008
/**
  * @}
  */

 /** @defgroup GPIO_IOMUX_Pin_selection_define  GPIO_IOMUX_Pin_selection_define
  * @{
  */
typedef enum
{
...
/** @defgroup GPIO_IOMUX_function_selection_define  GPIO_IOMUX_function_selection_define
  * @{
  */ 
...
#define IS_IOMUX_PIN(IOMUX_PIN)       (((IOMUX_PIN) == IOMUX_PIN1) ||((IOMUX_PIN) == IOMUX_PIN2) ||((IOMUX_PIN) == IOMUX_PIN4) ||\
...
/** @defgroup GPIO_IOMUX_TIM2_SOURCE_define  GPIO_IOMUX_TIM2_SOURCE_define
  * @{
  */ 
typedef enum
{
...
#define IS_TIM2_SOURCE(TIM2_SOURCE)       (((TIM2_SOURCE) == TIM2_CN1_EXTERNAL) || ((TIM2_SOURCE) == TIM2_CN1_HSIDIV) || \
                                          ((TIM2_SOURCE) == TIM2_CN1_LSI_40) || ((TIM2_SOURCE) == TIM2_CN1_EXTERNAL_MAX))
