...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
/* I2C CR1 clear register Mask */
#define CR1_CLEAR_MASK          ((uint32_t)0x80CFE0FF)  
     
/* I2C CR1 SWAP Mask */     
#define CR1_SWAP_Mask           ((uint32_t)0x80000000)  

/* I2C CR2 clear register Mask */
#define CR2_CLEAR_MASK          ((uint32_t)0x07FF7FFF)

/* I2C TIMING clear register Mask */
#define TIMING_CLEAR_MASK       ((uint32_t)0xF0FFFFFF) 

/* I2C Error interrupt register Mask */
...
@verbatim
 ...
 ===============================================================================
    [..] This section provides functions allowing to:
        ...
        (+) Enables or disables Exchange SDA/SCL pin
...
void I2C_DeInit(I2C_TypeDef* I2Cx)
{
  ...
  if (I2Cx == I2C)
  {
    ...
    RCC_APBPeriph1ResetCmd(RCC_APBPeriph1_I2C, ENABLE);
    /* Release I2Cx from reset state */
    RCC_APBPeriph1ResetCmd(RCC_APBPeriph1_I2C, DISABLE);
  }
...
/**
  * @brief  Enables or disables Exchange SDA/SCL pin.
  * @param  I2Cx: I2C.
...
void I2C_SwapCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
     /* Exchange SDA/SCL pin */
     I2C->CR1 |= CR1_SWAP_Mask; 
  }
  else
  {
     /* Don't Exchange SDA/SCL pin */
     I2C->CR1 &= (uint32_t)~((uint32_t)CR1_SWAP_Mask);
  }
}
...
void I2C_ITConfig(I2C_TypeDef* I2Cx, uint32_t I2C_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    /* Enable the selected I2Cx interrupts */
    I2Cx->CR1 |= I2C_IT;
  }
  else
  {
    /* Disable the selected I2Cx interrupts */
...
@verbatim
 ...
 ===============================================================================  
	[..] This section provides functions allowing to:
        (+) Enables or disables the I2C automatic end mode
...
@verbatim
 ...
 ===============================================================================  
    [..] This section provides functions allowing to:
		...
		(+)	Enables or disables I2C Clock Timeout
		(+)	Enables or disables I2C Extended Clock Timeout
		(+)	Enables or disables I2C Idle Clock Timeout
		(+)	Configures the I2C Bus Timeout A
		(+)	Configures the I2C Bus Timeout B
...
void I2C_ClockTimeoutCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    I2Cx->TIMEOUTR |= I2C_TIMEOUTR_TIMEOUTEN;   
  }
  else
  {
    /* Disable Clock Timeout */    
    I2Cx->TIMEOUTR &= (uint32_t)~((uint32_t)I2C_TIMEOUTR_TIMEOUTEN); 
  }
}
...
/** @defgroup I2C_Group6 Interrupts and flags management functions
...
/**
  * @brief  Clears the I2Cx pending flags.
  * @param  I2Cx: I2C.
